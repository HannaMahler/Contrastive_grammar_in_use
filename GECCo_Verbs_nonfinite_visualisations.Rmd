...
We will also need the files with verbs as rows, since not all the frequencies we want to look at are included in the data frame 'texts'. *Due to copyright reasons I had to reduce the columns "context_before" and "context_after" from 5 tokens to 1 token. A full version of the file is available upon request.*
...
nrow(verbs_nf_EO) + nrow(verbs_f_EO) # 68621
...
## percentage of non-finite verbs of all verb phrases
nrow(verbs_nf)/(nrow(verbs_nf) + nrow(verbs_f)) # 0.1675287
```


###3.0.1 Dispersion measure

This graph shows the dispersion of non-finite verb phrases over the corpus. Corpus text on x-axis, relative frequency of non-finite verb phrases in that text on the y-axis.
...
# for English only
cor(subset(texts, Language == "English")$vp_nf_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.1591607

# for both
cor(texts$vp_nf_phw, texts$STTR, method = "pearson") #-0.07081529
...
# for English only
cor(subset(registers, Language == "English")$vp_nf_phw_av, subset(registers, Language == "English")$STTR_av, method = "pearson") #0.1296858

# for both
cor(registers$vp_nf_phw_av, registers$STTR_av, method = "pearson") #-0.09463385
```


###3.4.3 Digression: relationship between information density and sub-types of non-finite verb phrases
...
# for English only
cor(subset(texts, Language == "English")$parpas_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.4420437

# for both
cor(texts$parpas_phw, texts$STTR, method = "pearson") #0.2512424
...
# for English only
cor(subset(texts, Language == "English")$parpre_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.25301

# for both
cor(texts$parpre_phw, texts$STTR, method = "pearson") #-0.07208902
...
# for English only
cor(subset(texts, Language == "English")$adv_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.04676375

# for both
cor(texts$adv_phw, texts$STTR, method = "pearson") #-0.1062779
...
# for English only
cor(subset(texts, Language == "English")$emb_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.5103366

# for both
cor(texts$emb_phw, texts$STTR, method = "pearson") #0.1877052
```
...
# for English only
cor(subset(texts, Language == "English")$nom_phw, subset(texts, Language == "English")$STTR, method = "pearson") #-0.2220856

# for both
cor(texts$nom_phw, texts$STTR, method = "pearson") #-0.2214181
```
...
# for English only
cor(subset(texts, Language == "English")$ind_phw, subset(texts, Language == "English")$STTR, method = "pearson") #-0.2544338

# for both
cor(texts$ind_phw, texts$STTR, method = "pearson") #-0.2278472
```
...
# for English only
cor(subset(texts, Language == "English")$subj_phw, subset(texts, Language == "English")$STTR, method = "pearson") #0.06101042

# for both
cor(texts$subj_phw, texts$STTR, method = "pearson") #0.01888388
```
...
# for German only
cor(subset(texts, Language == "German")$comps_phw, subset(texts, Language == "German")$STTR, method = "pearson") #0.229593

# for English only
cor(subset(texts, Language == "English")$comps_phw, subset(texts, Language == "English")$STTR, method = "pearson") # -0.2984793

# for both
cor(texts$comps_phw, texts$STTR, method = "pearson") # -0.2372619
```
...
```{r correlation coefficient}
# for English only
cor(subset(texts, Language == "English")$ovsub_phw, subset(texts, Language == "English")$STTR, method = "pearson") #-0.04833691
```
...
```{r English summary statistics}
## totals
freq_cltype_EO = verbs_nf_EO %>%
  group_by(clause_type) %>%
  count()
colnames(freq_cltype_EO) = c("clause_type", "freq_total")
freq_cltype_EO$clause_type = with(freq_cltype_EO, reorder(clause_type, freq_total))

freq_cltype_EO = freq_cltype_EO %>% 
         ## add percentages of all English non-finite vp
...
freq_ovsubj_form_spok_EO_infto <- freq_ovsubj_form_spok_EO %>% 
  filter(verb_form == "infinitive_to") 
freq_ovsubj_form_spok_EO_infto <- freq_ovsubj_form_spok_EO_infto %>%
