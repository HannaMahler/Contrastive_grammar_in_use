...
###3.1 Average number of verb phrases per sentence by register
...
###3.2 Average number of verb phrases per hundred words by register
...
##3.3 Relationship between register and VP-count
...
##3.4 Relationship between language and VP-count
...
##3.5 Relationship between Mode and VP-count
...
##3.6 Relationship between information density (=STTR) and VP-count

###3.6.1 On register level
...
# for German only
cor(registers_GO$vp_phw_av, registers_GO$STTR_av, method = "pearson") #-0.69

# for English only
cor(registers_EO$vp_phw_av, registers_EO$STTR_av, method = "pearson") #-0.69

# for both
cor(registers$vp_phw_av, registers$STTR_av, method = "pearson") #-0.706
...
```{r correlation coefficient}
# for German only
cor(texts_GO$vp_phw, texts_GO$STTR, method = "pearson") #-0.54

# for English only
cor(texts_EO$vp_phw, texts_EO$STTR, method = "pearson") #-0.62

# for both
cor(texts$vp_phw, texts$STTR, method = "pearson") #-0.62

```


##3.7 Relationship between text length and verbiness
...
##3.8 Assessing the relevance of non-finite verb phrases for the difference in "verbiness" between the two languages
